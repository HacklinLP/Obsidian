...
netstat --help
	...
	#c optie om IP-adressen (en poorten en users) niet te 'resolven' maar met cijfers te tonen 
	netstat -n
...
timedatectl list-timezones | grep Brussels #filteren en zoeken naar juiste tz-naam
